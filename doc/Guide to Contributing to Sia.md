...
$ cd $GOPATH/src/github.com/pachisi456/Sia
...
$GOPATH/src/github.com/pachisi456/Sia. Change to that directory and set up
...
there. You should maintain master as an up-to-date copy of the pachisi456/Sia 
repository's master branch.

To create and checkout a new branch:
```bash
# If you're not already in the right directory:
$ cd $GOPATH/src/pachisi456/Sia
...
[sia]: https://github.com/pachisi456/Sia
[branch]: http://blog.scottlowe.org/2015/01/27/using-fork-branch-git-workflow/
[developers.md]: https://github.com/pachisi456/Sia/blob/master/doc/Developers.md
[gofmt]: https://golang.org/cmd/gofmt/
[nutshell]: https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell
[discord]: https://discord.gg/sia
[install-git]: https://git-scm.com/book/en/v2/Getting-Started-Installing-Git
[test-doc]: https://github.com/pachisi456/Sia/blob/master/doc/Testing.md
